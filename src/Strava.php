...
class Strava
{
    ...
    # Strava Authenticate
    #
    public function authenticate($scope='read_all,profile:read_all,activity:read_all', $redirect_uri)
    {
      return redirect('https://www.strava.com/oauth/authorize?client_id='. $this->client_id .'&response_type=code&redirect_uri='. $redirect_uri . '&scope=' . $scope . '&state=strava');
    }
